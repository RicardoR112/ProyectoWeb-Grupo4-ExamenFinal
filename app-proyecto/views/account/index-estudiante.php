                ...
                <nav class="navbar-mobile">
                    <div class="container-fluid">
                        <ul class="navbar-mobile__list list-unstyled">
                            <li>
                                <a class="js-arrow" href="<?php echo constant('URL') ?>/estudiantedashboard">
                                            ...
                                            <a id="imageFather"href="#"  data-toggle="modal" data-target="#upload-photo">
                                                ...
                                                <h2 class="text-light display-6"><?php echo  $this->data['user']->getNombres(); ?>
                                                        &nbsp;<?php
                                                                ...
                                                                ?></h2>
                                                    <p class="text-light display-6">Estudiante <b>Articulos</b></p>
                                                </div>
                                            </div>
                                        </div>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="form-group">
                        <input type="file" id="fileToUpload" onchange="upload_image_estudiante();">
                        <b>
