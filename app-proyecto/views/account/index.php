                                    ...
                                    <section class="card">
                                        <div class="card-header user-header alt bg-dark">
                                            ...
                                            <a id="imageFather"href="#"  data-toggle="modal" data-target="#upload-photo">
                                                    <?php if ($this->data['user']->getPhoto() == '') { ?>
                                                        <img id="imageSession"src="assets/images/profile-default.png" class="profile-img" style="width:85px; height:85px;border-radius: 50%;" alt="defaultPhoto">
                                                    <?php } else { ?>
                                                ...
                                                <h2 class="text-light display-6"><?php echo  $this->data['user']->getNombres(); ?>
                                                        &nbsp;<?php
                                                                ...
                                                                ?></h2>
                                                    <p class="text-light display-6">Administrador de <b>Articulos</b></p>
                                                </div>
                                            </div>
                                        </div>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="form-group">
                        <input type="file" id="fileToUpload" onchange="upload_image_admin();">
                        <b>
