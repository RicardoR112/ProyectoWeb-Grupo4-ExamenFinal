                          ...
                          <div class="row">
                                <div class="col-md-12">
                                    <div class="overview-wrap">
                                        <h2 class="title-1">Articulos a Evaluar</h2>
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <tbody>
                                        <?php foreach ($articulos as $clave => $valor) { ?>
                                            <tr>
                                                ...
                                                <td><a class="btn btn-info" data-toggle="modal" data-target="#calificar"  data-idarticulo="<?php echo $valor->getId(); ?>" data-idcalificador="<?php echo  $valor->getIdCalificador(); ?>" data-autor="<?php echo  $valor->getAutor(); ?>" data-idautor="<?php echo $valor->getIdEstudiante(); ?>"  data-fecha="<?php echo  $valor->getFecha(); ?>" data-titulo="<?php echo  $valor->getTitulo(); ?>" href="#"> <i class="zmdi zmdi-edit"></i>&nbsp;&nbsp;Calificar</a></td>
                                                <td><a class="btn btn-success" href="<?php echo constant('URL') ?>/accountcalificador/download?id=<?php  echo  $valor->getId(); ?>">
                                           Descargar&nbsp;&nbsp;&nbsp;&nbsp;<i class="zmdi zmdi-download"></i></td>
                                                <input type="hidden" id="<?php echo $valor->getIdEstudiante(); ?>">
                                            </tr>
                                        <?php
                                        }
                                        ?>
...
<div class="modal fade" id="calificar" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <i class="zmdi zmdi-book"></i> &nbsp;&nbsp;<h4 class="modal-title" id="labelArticulo"></h4>&nbsp;&nbsp; <h5>por</h5> &nbsp;&nbsp;<h4 id="labelAutor"></h4> 
                    
                    <input id="id_articulo" type="hidden" value="">
                ...
                <div class="modal-body">
                    <div id="message"></div>
                    <h4>Publicado </h4><h4 id="labelFecha"></h4><br>
                    
                      
                    &nbsp;&nbsp;&nbsp;&nbsp;<input type="text" name="calificacion" id="calificacion" placeholder="Ingrese la calificacion!">
                    
                </div>
                
                <div class="modal-footer">
                    
                    <a href="javascript:guardarCalificacion()" class="btn btn-info btn-ok">Confirmar</a>
